package com.wyz.springcloud.common;
...
import com.wyz.springcloud.common.bean.Bean;
import com.wyz.springcloud.common.bean.Bean1;
import com.wyz.springcloud.common.bean.Bean2;
...
public class PictureUtil {
    ...
    public static void graphicsGeneration(String path, Bean bean) {
        ...
        Bean1 policyPersonDto = bean.getBean1();
        Bean2 policyProductDto = bean.getBean2();

        int num = 50;
        graphics.drawString("手机号      : " + 1328888888, 50, num);
        num += 50;
        graphics.drawString("登陆密码    : " + 1328888888, 50, num);
        num += 50;
        graphics.drawString("身份证号    : " + 1328888888, 50, num);
        num += 50;
        graphics.drawString("姓名        : " + 1328888888, 50, num);
        num += 50;
        graphics.drawString("所在地区    : " + 1328888888, 50, num);
        num += 50;
        graphics.drawString("常住地址    : " + 1328888888, 50, num);
        num += 50;
        graphics.drawString("微信号      : " + 1328888888, 50, num);
        num += 50;
        graphics.drawString("QQ号        : " + 1328888888, 50, num);
        num += 50;
        graphics.drawString("Email       : " + 1328888888, 50, num);
        num += 50;
        graphics.drawString("品牌        : " + 1328888888, 50, num);
    ...
    public static void main(String[] args) {
        ...
        createImage("/Users/wyz/test1.jpg", image);
